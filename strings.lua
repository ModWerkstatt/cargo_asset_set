...
return {
	de = {
		...
		["desc_mod"] = (
			"[h2][b] Cargo Asset Set Version 1.61 [/b][/h2]\n" ..
				...
				"[h2][b]Inhalt[/b][/h2]\n" ..
				"[list]" ..
				"[*][b]Container  20/40/45/53 Fuss[/b]  Std. Bauhöhe 2.6m\n" ..
				"[*][b]Container  20/40 Fuss[/b] High Cube 2.9m\n" ..
				"[*][b]Tanktainer 20/26 Fuss[/b] 26 Fuss in 2 Varianten \n" ..
				"[*][b]Cargo Mix[/b] Granitblöcke, Stahlträger, Rohre usw \n" ..
				"[*][b]Krone Trailer[/b] [b]**[/b] \n" ..
				"[/list]"..
				" \n" ..
				"[b]**[/b] Asset Menu zum platzieren der Krone Sattelauflieger findet Ihr in diesen LKW Mods von Nando: \n" ..
				...
				"[*]Container mit Stapel- und Neigfunktion \n" ..
				...
				" \n" ..
				"Die Container, Tanktainer, Krone Trailer und der Cargo Mix dürfen verlinkt in deinem Mod als Ladung oder im Falle der Trailer, als Bestandteil deines Fahrzeugmods, benutzt werden.\n" ..
				"Du darfst jederzeit auf diesen Mod zurückgreifen. \n" ..
				"Die Bedingung ist, dass dieser Mod mit installiert sein muss und sich keine Dateien des Asset Set in deinem Mod befinden. \n" ..
				"Die Trailer können entweder als Ladung auf einem Güterzug, oder als Auflieger für einen LKW genutzt werden.\n" ..
				"Diesem Mod liegen Textdateien bei, in diesen findest Du alle wichtigen Dateipfade. \n" ..
				"\n" ..
				"[h2][b]Disclaimer: [/b][/h2]\n" ..
				"Die Veröffentlichung der Dateien ob in modifizierter Form oder unverändert (in Repaint´s oder ähnlichem) darf nicht ohne ausdrückliche Erlaubnis des Autors erfolgen.\n" ..
				"Das Hochladen dieser Modifikation auf anderen Seiten ist nicht gestattet."),

		["name_asset1"] = "Container Set",
		["desc_asset1"] = "20/40/45/53 Fuss Container",
		["name_asset2"] = "Container High Cube Set",
		["desc_asset2"] = "20 und 40 Fuss High Cube Container",
		["name_asset3"] = "Tanktainer Set",
		["desc_asset3"] = "20 und 26 Fuss Tank Container",
		["name_asset4"] = "Cargo Mix",
		["desc_asset4"] = "Verschiedene Bau + Konstruktions Elemente",
		["name_size"] = "Länge",
		["name_brand"] = "Marke",
		["name_position"] = "Bauhöhe",
		["name_hintereinander"] = "Hintereinander",
		["name_nebeneinander"] = "Nebeneinander",
		["name_abstand"] = "Abstand zwischen den Reihen",
		["name_stapel"] = "Zufall                     Stapelhöhe                      Aufgefüllt",
		["name_pouj"] = "Neigen mit Tastenkürzel POUJ",
	...
	en = {
		...
		["desc_mod"] = (
				...
				"[h2][b]Content[/b][/h2]\n" ..
				"[list]" ..
				"[*][b]Container  20/40/45/53 feet[/b]  Std. height 8.6 ft\n" ..
				"[*][b]Container  20/40 feet[/b] High Cube 9.5 ft\n" ..
				"[*][b]Tanktainer 20/26 feet[/b] 26 feet in 2 variants \n" ..
				"[*][b]Cargo Mix[/b] Granite blocks, steel beams, pipes, etc. \n" ..
				"[*][b]Krone semitrailer[/b] [b]**[/b] \n" ..
				"[/list]"..
				" \n" ..
				"[b]**[/b] Asset menu to place the Krone semitrailers you can find in these truck mods from Nando: \n" ..
				"https://steamcommunity.com/sharedfiles/filedetails/?id=1962843709 \n" ..
				"https://steamcommunity.com/sharedfiles/filedetails/?id=2146074181 \n" ..
				" \n" ..
				"[h1][b]NEW:[/b][/h1]\n" ..
				...
				"[*]Container with stacking and slope function \n" ..
				...
				" \n" ..
				"The Containers, Tanktainer, Krone Trailer and the Cargo Mix may be used linked in your mod as cargo or in case of the trailers, as part of your vehicle mod.\n" ..
				"You can always access this mod. \n" ..
				"The condition is that this mod must be installed too and there are no files of this Asset Set in your Mod. \n" ..
				"The trailers can be used either as cargo on a freight train, or as a trailer for a truck. \n" ..
				"This mod contains text files, in which you will find all important file paths. \n" ..
				"\n" ..
				"[h2][b]Disclaimer: [/b][/h2]\n" ..
				"The publication of the files, whether in modified form or unchanged (in repaints or similar) may not take place without the express permission of the author.\n" ..
				"Uploading this mod to other sites is not allowed."),
		...
		["name_size"] = "Size",
		["name_brand"] = "Brand",
		["name_position"] = "Construction height",
		["name_hintereinander"] = "In a row",
		["name_nebeneinander"] = "Side by side",
		["name_abstand"] = "Space between the rows",
		["name_stapel"] = "Random                   Stacking height                  Filled up",
		["name_pouj"] = "Slope with shortcut keys POUJ",
